...
from dataset_utils import _dataset_exists, _get_filenames_and_classes_mnist, write_label_file, _convert_dataset
...
def main():
    ...
    photo_filenames, class_names = _get_filenames_and_classes_mnist(FLAGS.dataset_dir)
